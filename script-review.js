// script-review.js - Logic cho trang ôn tập (review.html)

window.addEventListener('DOMContentLoaded', () => {
  // start index for question numbering (câu bắt đầu từ 1)
  const startIndex = 1;
  ...
  if (!listInner || !questionEl || !answersDiv) {
    console.error('Missing DOM elements. Check review.html structure.');
    return;
  }
